...
Patch0001:     0001-selinux-Redevelop-SELinux-policy-for-Fedora-40-ditch.patch
...
%postun selinux
if [ $1 -eq  0 ]; then
  for p in swtpm_libvirt swtpm_svirt swtpm; do
...
%changelog
* Thu May 02 2024 Jordan Pryde <jordan@pryde.me> - 0.8.2-1_jxpryde
- Forwardport SELinux fixes
